...
export class XfceComponent implements OnInit {
  ...
  distro = {
    nic: 'xfce',
    name : 'Xfce',
    desc: 'Xfce is a lightweight desktop environment well known for being a rock-solid & stable. It aims to be fast and low on system resources, while still being visually appealing and user friendly.' ,
    metadesc: 'Xfce is a lightweight desktop environment well known for being a rock-solid & stable. It aims to be fast and low on system resources, while still being visually appealing and user friendly.' ,
    edition: 210506,
    kernel: 'zen'
  };
